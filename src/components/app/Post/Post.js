    ...
    <div className="bg-grey p-4 rounded-2xl mb-5">
      <div className="flex justify-around gap-5 ">
        ...
        <div className="flex flex-col flex-1 gap-5">
          ...
          <p className="text-slate-300 text-sm pe-4 line-clamp-3">
          ...
          <div className="flex gap-3 items-center justify-between mb-4">
            <div className="flex gap-1 items-center">
              ...
              <span className="text-slate-400 text-sm">243k</span>
            </div>
            <a
          ...
          <div className="flex items-center gap-3">
            <button className="bg-darkgrey p-3 px-4 w-full rounded-2xl flex items-center gap-3 hover:opacity-70 transition justify-center text-sm">
